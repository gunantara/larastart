            ...
            <form role="form" enctype="multipart/form-data">
              ...
              <div class="card-footer">
                <router-link to="/option">
                  <button type="submit" class="btn btn-success" @click="UpdateQuestion()">Update</button>
                </router-link>
              </div>
            </form>
          </div>
...
export default {
  ...
  created() {
    axios
      .get(`api/edit-question/${this.$route.params.questionid}`)
      .then(response => {
  ...
  methods: {
    UpdateQuestion() {
      this.$Progress.start();
      this.form
        .put("api/question/" + this.$route.params.questionid)
        .then(() => {
          toast({
            type: "success",
        ...
        .catch(() => {
          toast({
            type: "error",
            title: "Something wrong when update a Question"
          });
        });
    }
  }
